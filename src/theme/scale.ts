...
export const curtain = Object.freeze({
  ...
  200: '#EDB7B7',
  /** Soft accent — muted icon fills and low-emphasis interactive states */
  300: '#DC8888',
