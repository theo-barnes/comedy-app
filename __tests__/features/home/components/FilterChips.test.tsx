...
describe('FilterChips', () => {
  it('renders without crashing', () => {
    expect(() =>
      renderWithTheme(<FilterChips options={OPTIONS} selected="All" onSelect={() => {}} />),
    ).not.toThrow();
  });
  ...
  it('calls onSelect with the tapped value', () => {
    ...
    renderWithTheme(<FilterChips options={OPTIONS} selected="All" onSelect={onSelect} />);
  ...
  it('marks the selected chip with accessibilityState.selected=true', () => {
    renderWithTheme(<FilterChips options={OPTIONS} selected="Improv" onSelect={() => {}} />);
