...
describe('DiscoverShell', () => {
  it('renders Discover inline tabs in header and no mode icons', () => {
  ...
  it('switches views when header tabs are pressed', () => {
    const config = getDiscoverConfig('fan');
    ...
    expect(screen.getByText(config.map.searchPlaceholder)).toBeTruthy();
  });
});
